...
import { GenerateFamiliesRequest } from "@/app/types";
  ...
  "families": [
    ...
    const completion = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: "system",
          content: "You generate ONLY Western-style family names for Korean romance fantasy writers. Never output Korean-style family names. JSON ONLY.",
        },
        {
          role: "user",
          content: prompt,
